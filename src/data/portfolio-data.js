export const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "An AI-powered dermatology assistant that uses deep learning and computer vision techniques to classify skin diseases from medical images. The platform combines a modern React frontend, Flask backend, and machine learning inference pipeline to deliver intelligent and fast diagnostic assistance.",
      category: "Medical AI",
      tags: ["React", "Vite", "Flask", "TensorFlow", "CNN", "Python", "TailwindCSS"],
      github: "https://github.com/Shaheel-08/AI-powered-Skin-disease-classfication.git",
      ...
      features: [
        "Multi-class classification of 23 skin diseases",
